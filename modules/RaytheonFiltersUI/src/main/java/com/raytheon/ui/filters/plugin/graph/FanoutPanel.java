...
public class FanoutPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        labelNodeId.setText(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "EgoPanel.labelNodeId.text")); // NOI18N

        nodeIdTextField.setText(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "EgoPanel.nodeIdTextField.text")); // NOI18N
        nodeIdTextField.setToolTipText(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "EgoPanel.nodeIdTextField.toolTipText")); // NOI18N

        labelDepth.setText(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "EgoPanel.labelDepth.text")); // NOI18N

        depthComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "2", "3", "Max" }));

        okButton.setText(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "EgoPanel.okButton.text")); // NOI18N
        okButton.setActionCommand(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.okButton.actionCommand")); // NOI18N
        okButton.setLabel(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.okButton.label")); // NOI18N
        okButton.setMargin(new java.awt.Insets(2, 7, 2, 7));

        withSelfCheckbox.setText(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "EgoPanel.withSelfCheckbox.text")); // NOI18N
        withSelfCheckbox.setActionCommand(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.withSelfCheckbox.actionCommand")); // NOI18N
        withSelfCheckbox.setLabel(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.withSelfCheckbox.label")); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(nodeIdTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
        ...
        labelNodeId.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.labelNodeId.AccessibleContext.accessibleDescription")); // NOI18N
        labelDepth.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.labelDepth.AccessibleContext.accessibleName")); // NOI18N
        labelDepth.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(FanoutPanel.class, "FanoutPanel.labelDepth.AccessibleContext.accessibleDescription")); // NOI18N
